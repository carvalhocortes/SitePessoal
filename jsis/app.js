...
function validateForm() {
    ...
    if(usernameInput.value.trim()==''){
        //cria erro vazio
        setError(usernameInput, 'O nome não pode ficar em branco.');
    //verifica se o nome tem a quantidade de letras certa
        ...
        setError(usernameInput, 'O nome deve ter de 4 até 15 letras.');
    ...
    if(emailInput.value.trim()==''){
        //cria erro vazio
        setError(emailInput, 'Coloque um endereço de e-mail.');
    ...
    //se não existem erros seta como sucesso.
        ...
        setError(emailInput, 'O formato do e-mail não é valido.');
    }
}
//marca erro
